...
export default function FilmGuideHeroSection() {
    ...
    const updateThumbnailMovies = (featured: Movie, allMovies: Movie[]) => {
        ...
        const remainingMovies = allMovies.filter(movie => movie.id !== featured.id);
        ...
        return (
            <div className="w-full h-[600px] bg-gray-900 dark:bg-gray-950 animate-pulse flex items-center justify-center">
                <div className="space-y-4 text-center">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 text-xl font-medium">Loading featured movies...</p>
                </div>
            </div>
        );
    }

    const backdropUrl = tmdbService.getBackdropURLProxy(featuredMovie.backdrop_path);
            ...
            <div className="relative h-full container mx-auto px-4 py-8 flex flex-col md:flex-row">
                ...
                >
                    ...
                    <motion.div 
                        ...
                        transition={{ type: "spring", stiffness: 300 }}
                    >
                        <h3 className="text-lg font-medium text-white mb-3">More to Watch</h3>
                        <div className="space-y-3">
                            {thumbnailMovies.map(movie => (
                                ...
                                >
                                    <div className="relative w-16 h-24 flex-shrink-0 overflow-hidden rounded">
                                        {tmdbService.getPosterURLProxy(movie.poster_path, 'w92') && (
                                            <Image
                                                src={tmdbService.getPosterURLProxy(movie.poster_path, 'w92') || ''}
                                                alt={movie.title}
                                                fill
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-1 flex items-center">
                                            <span className="text-yellow-500 text-xs font-bold mr-1">★</span>
