...
describe('TMDBService', () => {
  ...
  describe('getPosterURLProxy', () => {
    ...
    it('should return correct proxy URL for valid path', () => {
      ...
      const expectedUrl = '/api/image-proxy?url=https%3A%2F%2Fimage.tmdb.org%2Ft%2Fp%2Fw342%2Ftest-poster.jpg';
  ...
  describe('getBackdropURLProxy', () => {
    ...
    it('should return correct proxy URL for valid path', () => {
      ...
      const expectedUrl = '/api/image-proxy?url=https%3A%2F%2Fimage.tmdb.org%2Ft%2Fp%2Fw1280%2Ftest-backdrop.jpg';
  ...
  describe('getPopularMovies', () => {
    ...
    it('should throw error when API token is not set', async () => {
      ...
      await expect(tmdbService.getPopularMovies()).rejects.toThrow('TMDB_ACCESS_TOKEN is not set');
    });
  });
